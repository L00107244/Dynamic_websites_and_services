...
<div id= logo>
<a href="http://localhost:8080/web-noSQL/webpages/index.jsp"><img src="WebContent/webpages/Sample_photos/logo/main_logo.JPG"></a>
<div id = Quote>
...
<form action="/action_page.php">
  <input type="image" src= "WebContent/webpages/Sample_photos/buttons/microphone.jpg"width="30" height="30"alt="Speech_navigation">
</form>
</div>
</div>
